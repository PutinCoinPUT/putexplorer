...
module.exports = {
  ...
  get_circulatingsupply: function(richlist, stats, cb) {
    ...
    lib.syncLoop(richlist.balance.length, function (loop) {
     ...
     if (count <= 25 ) {
       /* distribution.t_1_25.percent = distribution.t_1_25.percent + percentage; */
        distributionvalues.t_1_25.total = distributionvalues.t_1_25.total + (richlist.balance[i].balance / 100000000);
      }

      if (count <= 50 && count > 25) {
        /* distribution.t_26_50.percent = distribution.t_26_50.percent + percentage; */
        distributionvalues.t_26_50.total = distributionvalues.t_26_50.total + (richlist.balance[i].balance / 100000000);
      }

      if (count <= 75 && count > 50) {
        /* distribution.t_51_75.percent = distribution.t_51_75.percent + percentage; */
        distributionvalues.t_51_75.total = distributionvalues.t_51_75.total + (richlist.balance[i].balance / 100000000);
      }

      if (count <= 100 && count > 75) {
        /* distribution.t_76_100.percent = distribution.t_76_100.percent + percentage; */
        distributionvalues.t_76_100.total = distributionvalues.t_76_100.total + (richlist.balance[i].balance / 100000000);
      }
      ...
      distributionvalues.t_101plus.total = parseFloat(stats.supply - distributionvalues.t_76_100.total - distributionvalues.t_51_75.total - distributionvalues.t_26_50.total - distributionvalues.t_1_25.total - (settings.richlist_page.burned_coins.include_burned_coins_in_distribution == true && richlist.burned > 0 ? (richlist.burned / 100000000) : 0)).toFixed(8);

      /* distribution.t_1_25.percent = parseFloat(distribution.t_1_25.percent).toFixed(2); */
      distributionvalues.t_1_25.total = parseFloat(distributionvalues.t_1_25.total).toFixed(8);
      /* distribution.t_26_50.percent = parseFloat(distribution.t_26_50.percent).toFixed(2); */
      distributionvalues.t_26_50.total = parseFloat(distributionvalues.t_26_50.total).toFixed(8);
      /* distribution.t_51_75.percent = parseFloat(distribution.t_51_75.percent).toFixed(2); */
      distributionvalues.t_51_75.total = parseFloat(distributionvalues.t_51_75.total).toFixed(8);
      /* distribution.t_76_100.percent = parseFloat(distribution.t_76_100.percent).toFixed(2); */
      distributionvalues.t_76_100.total = parseFloat(distributionvalues.t_76_100.total).toFixed(8);

      distribution = parseFloat(stats.supply - distributionvalues.t_1_25.total - distributionvalues.t_26_50.total).toFixed(8);

...
exports.api_page = {
  ...
  "public_apis": {
    ...
    "ext": {
      ...
      // getcirculatingsupply: a collection of settings that pertain to the /ext/getcirculatingsupply api endpoint
      //                  Returns stats on the freely circulating coin supply
      //                  NOTE: This api is not used internally and is therefore only publicly available
      "getcirculatingsupply": {
        // enabled: Enable/disable the /ext/getcirculatingsupply api endpoint (true/false)
        //          If set to false, the /ext/getcirculatingsupply api will be completely disabled for public use (no definition on the api page and a disabled error msg if you try to call the endpoint direct$
        "enabled": true
      },
